...
const about_data_EN = [
    {
        banner1: "Our focus is your Best Interest and your Best Fixed Income Interest." ,
        text2: [{
            photo: '/course1.jpg',
        ...
        {
            photo: '/course3.jpg',
            title: "Al Bond Portfolio Monitoring",
            description: 'Our portfolio monitoring service utilizes Al to track investments and provide real-time alerts, ensuring your portfolio is continually optimized.',
